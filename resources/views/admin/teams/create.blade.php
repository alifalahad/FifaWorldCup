...
@section('page-title', 'New Team')
@section('breadcrumb', 'Admin › Teams › Create')
...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.teams.store') }}" class="bg-white rounded-lg border border-gray-200 p-6">
        @csrf
