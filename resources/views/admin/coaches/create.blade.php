...
@section('page-title', 'New Coach')
@section('breadcrumb', 'Admin › Coaches › Create')
...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.coaches.store') }}" class="bg-white rounded-lg border border-gray-200 p-6">
        @csrf
